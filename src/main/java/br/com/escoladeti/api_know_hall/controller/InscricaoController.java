...
public class InscricaoController {
    ...
    public ResponseEntity<InscricaoResponseDTO> inscrever(
        @Valid @RequestBody InscricaoCreateDTO dto,
        Principal principal
    ) {
        InscricaoResponseDTO inscricao = inscricaoService.inscrever(principal.getName(), dto.getWorkshopId());
    ...
    public ResponseEntity<InscricaoResponseDTO> atualizarStatus(
        ...
        @Valid @RequestBody InscricaoUpdateDTO dto
    ) {
        InscricaoResponseDTO inscricao = inscricaoService.atualizarStatusInscricao(inscricaoId, dto.getStatus());
        return ResponseEntity.ok(inscricao);
    }
}
