...
class UsuarioServiceTest {
    ...
    void getUsuarioById_WithInvalidId_ShouldReturnNull() {
        ...
        Usuario result = usuarioService.getUsuarioById(999);
    ...
    void updateUsuario_WithValidData_ShouldReturnUpdatedUsuario() {
        ...
        Usuario result = usuarioService.updateUsuario(1, usuarioUpdateDTO);
    ...
    void updateUsuario_WithInvalidId_ShouldThrowException() {
        ...
        assertThrows(RuntimeException.class, () -> {
            usuarioService.updateUsuario(999, usuarioUpdateDTO);
        });
        verify(usuarioRepository, times(1)).findById(999);
